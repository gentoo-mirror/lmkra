...
RDEPEND="
	...
	>=dev-python/mautrix-0.20.2[${PYTHON_USEDEP}]
...
src_install() {
	...
	python_setup
	python_moduleinto mautrix_facebook
	python_domodule mautrix_facebook/example-config.yaml
}
